    ...
    return (
        <div className={`group flex cursor-pointer flex-col ${className}`}>
            ...
            <div className="relative mb-5 aspect-4/5 w-full overflow-hidden rounded-2xl border border-gray-100 bg-gray-50 transition-shadow duration-500 group-hover:shadow-[0_20px_40px_rgba(0,0,0,0.1)] dark:border-white/5 dark:bg-[#111] dark:group-hover:shadow-[0_20px_40px_rgba(0,0,0,0.4)]">
                ...
                {/* Wishlist Icon */}
                <div className="absolute right-4 top-4 transform rounded-full bg-white/90 p-2 text-gray-400 shadow-sm backdrop-blur-md transition-all duration-300 hover:text-red-500 group-hover:scale-110 dark:bg-black/80 dark:text-gray-500 dark:hover:text-red-500">
                    <Heart size={16} />
                </div>
                ...
                <div className="absolute bottom-6 left-1/2 z-20 flex w-full -translate-x-1/2 translate-y-4 justify-center gap-3 opacity-0 transition-all duration-500 group-hover:translate-y-0 group-hover:opacity-100 px-4">
                    ...
                    <button className="hover:bg-gray-100 dark:hover:bg-gray-800 flex h-10 w-10 items-center justify-center rounded-full bg-white text-gray-900 shadow-lg transition-colors dark:bg-[#222] dark:text-white">
                         <ShoppingBag size={14} />
                    </button>
                </div>
            </div>
