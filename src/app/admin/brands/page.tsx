...
const mockData: BrandData[] = [
    { id: "IDX-001", name: "Cartier", description: "The ultimate luxury from France.", isActive: true, productCount: 42 },
    { id: "IDX-002", name: "Tiffany", description: "New York master jewelers.", isActive: true, productCount: 15 },
];
...
export default function AdminBrandsPage() {
    ...
    const [selectedItem, setSelectedItem] = useState<BrandData | null>(null);
    ...
    const openEdit = (item: BrandData) => {
        setDrawerMode("EDIT");
        setSelectedItem(item);
        setIsDrawerOpen(true);
    };

    const openDelete = (item: BrandData) => {
        setSelectedItem(item);
