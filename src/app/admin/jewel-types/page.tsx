...
const mockData: JewelTypeData[] = [
    { id: "IDX-001", name: "Women", description: "Feminine designs featuring delicate and elegant silhouettes.", isActive: true, productCount: 42 },
    { id: "IDX-002", name: "Unisex", description: "Versatile designs suitable for all genders.", isActive: true, productCount: 15 },
];
...
export default function AdminJewelTypesPage() {
    ...
    const [selectedItem, setSelectedItem] = useState<JewelTypeData | null>(null);
    ...
    const openEdit = (item: JewelTypeData) => {
        setDrawerMode("EDIT");
        setSelectedItem(item);
        setIsDrawerOpen(true);
    };

    const openDelete = (item: JewelTypeData) => {
        setSelectedItem(item);
                        ...
                        <div className="border-t border-gray-100 bg-gray-50/50 p-6 dark:border-gray-800 dark:bg-[#1a1a1a]/50">
                            <div className="flex gap-3">
                                ...
                                <button className="flex-1 rounded-xl bg-blue-600 py-3 font-plus-jakarta text-sm font-bold text-white shadow-sm hover:bg-blue-700 active:scale-95">
                                    {drawerMode === "CREATE" ? "Add Segment" : "Save Changes"}
                                </button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="relative w-full max-w-md scale-100 rounded-3xl bg-white p-6 shadow-2xl dark:bg-[#161616] border border-gray-100 dark:border-gray-800">
                        ...
                        <div className="mt-5 text-center">
                            ...
                            <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">
                                This action is high-risk. There are <strong className="text-rose-500">{selectedItem.productCount} items</strong> assigned to this target segment.
                            </p>
                        </div>
