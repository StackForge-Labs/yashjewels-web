...
const mockData: JewelTypeData[] = [
    { id: "IDX-001", name: "Nữ", description: "Trang sức thiết kế nhỏ nhắn, tinh tế cho phái đẹp.", isActive: true, productCount: 42 },
    { id: "IDX-002", name: "Unisex", description: "Dành cho mọi giới tính.", isActive: true, productCount: 15 },
];
                    ...
                    <div className="relative w-full max-w-md bg-white shadow-2xl dark:bg-[#111] flex flex-col h-full border-l border-gray-100 dark:border-gray-800">
                        <div className="flex items-center justify-between border-b border-gray-100 px-6 py-5 dark:border-gray-800">
                            <div>
                                ...
                                <p className="font-plus-jakarta text-xs text-gray-500 mt-1">Quản lý nhóm đối tượng sử dụng chuyên biệt.</p>
                            </div>
                        </div>
