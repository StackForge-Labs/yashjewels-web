...
const mockData: CertificationData[] = [
    { id: "IDX-001", name: "GIA (Gemological Institute of America)", description: "Mã P102931 - Viện đá quý Hoa Kỳ.", isActive: true, productCount: 42 },
    { id: "IDX-002", name: "SJC (Saigon Jewelry Company)", description: "Giấy chứng nhận nội địa Việt Nam.", isActive: true, productCount: 15 },
];
            ...
            <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
                <div>
                    <h1 className="font-serif text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                        Chứng Nhận Kiểm Định (Certifications)
                    </h1>
                    <p className="mt-1 font-plus-jakarta text-sm text-gray-500 dark:text-gray-400">
                        Quản lý thông tin chứng nhận kim cương đá quý.
                    </p>
                </div>
                <button 
                    onClick={openCreate}
                    ...
                    <div className="relative w-full max-w-md bg-white shadow-2xl dark:bg-[#111] flex flex-col h-full border-l border-gray-100 dark:border-gray-800">
                        <div className="flex items-center justify-between border-b border-gray-100 px-6 py-5 dark:border-gray-800">
                            <div>
                                ...
                                <p className="font-plus-jakarta text-xs text-gray-500 mt-1">Quản lý thông tin chứng nhận kim cương đá quý.</p>
                            </div>
                        </div>
