                                    ...
                                    <tr key={item.id} className="group transition-colors hover:bg-gray-50/50 dark:hover:bg-gray-800/20">
                                        <td className="px-6 py-4">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    <p className="font-plus-jakarta text-sm font-bold text-gray-900 dark:text-white">{item.gradeName}</p>
                            ...
                            <div className="flex flex-col gap-5">
                                <div>
                                    ...
                                    <input 
                                        ...
                                        name="gradeName"
                                        required
                                        defaultValue={selectedItem?.gradeName || ""}
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                    ...
                    <div className="relative w-full max-w-md scale-100 rounded-3xl bg-white p-6 shadow-2xl dark:bg-[#161616] border border-gray-100 dark:border-gray-800">
                        ...
                        <div className="mt-5 text-center">
                            <h3 className="font-serif text-xl font-bold text-gray-900 dark:text-white">Delete {selectedItem.gradeName}?</h3>
