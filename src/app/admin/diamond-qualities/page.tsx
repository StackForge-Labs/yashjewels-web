...
const mockData: DiamondQualityData[] = [
    { id: "IDX-001", name: "D / IF", description: "Colorless D-grade diamond, Internally Flawless (IF).", isActive: true, productCount: 42 },
    { id: "IDX-002", name: "F / VVS1", description: "Colorless F-grade, Very Very Slightly Included (VVS1).", isActive: true, productCount: 15 },
];
                    ...
                    <table className="w-full whitespace-nowrap text-left text-sm">
                        <thead className="border-b border-gray-100 bg-gray-50/50 dark:border-gray-800/50 dark:bg-[#111]/50">
                            <tr>
                                ...
                                <th className="px-6 py-4 font-plus-jakarta text-[10px] font-bold uppercase tracking-[0.2em] text-gray-400 dark:text-gray-500 max-w-[200px]">Description / Level</th>
                    ...
                    <div className="relative w-full max-w-md bg-white shadow-2xl dark:bg-[#111] flex flex-col h-full border-l border-gray-100 dark:border-gray-800">
                        <div className="flex items-center justify-between border-b border-gray-100 px-6 py-5 dark:border-gray-800">
                            <div>
                                ...
                                <p className="font-plus-jakarta text-xs text-gray-500 mt-1">Manage 4Cs grading specification for diamond inventory.</p>
                            </div>
                        </div>
                            ...
                            <div className="flex flex-col gap-5">
                                <div>
                                    <label className="mb-1.5 block text-xs font-bold text-gray-700 dark:text-gray-300">
                                        Grade Level Name <span className="text-rose-500">*</span>
                                    </label>
                                    <input 
                                        type="text" 
                                ...
                                <div className="flex items-center justify-between rounded-xl border border-gray-200 p-4 dark:border-gray-800">
                                    <div>
                                        ...
                                        <p className="text-xs text-gray-500">Customers will see this grading specification in diamond details.</p>
                                    </div>
                        ...
                        <div className="border-t border-gray-100 bg-gray-50/50 p-6 dark:border-gray-800 dark:bg-[#1a1a1a]/50">
                            <div className="flex gap-3">
                                ...
                                <button className="flex-1 rounded-xl bg-blue-600 py-3 font-plus-jakarta text-sm font-bold text-white shadow-sm hover:bg-blue-700 active:scale-95">
                                    {drawerMode === "CREATE" ? "Add Grading" : "Save Changes"}
                                </button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="relative w-full max-w-md scale-100 rounded-3xl bg-white p-6 shadow-2xl dark:bg-[#161616] border border-gray-100 dark:border-gray-800">
                        ...
                        <div className="mt-5 text-center">
                            ...
                            <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">
                                What&apos;s this? Learn more about diamond qualities.
                                This action is high-risk. There are <strong className="text-rose-500">{selectedItem.productCount} items</strong> tied to this specific quality grade.
                            </p>
                        </div>
