                    ...
                    <div className="grid grid-cols-1 gap-16 lg:grid-cols-2">
                        ...
                        <div className="rounded-3xl border border-gray-100 p-8 shadow-sm md:p-12 dark:border-white/5 dark:bg-white/2">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                                    <div className="space-y-2">
                                        ...
                                        <input
                                            required
                                            type="text"
                                            className="w-full rounded-xl border border-gray-100 bg-white px-5 py-4 text-sm outline-none transition-colors focus:border-gold dark:border-white/5 dark:bg-white/5 dark:text-white"
                                ...
                                <button
                                    type="submit"
                                    className="bg-gold group flex h-16 w-full items-center justify-center gap-3 rounded-2xl text-xs font-bold tracking-[0.3em] text-white uppercase shadow-lg shadow-gold/20 transition-all hover:brightness-110 active:scale-[0.98]"
                                >
                                    Submit Inquiry
                        ...
                        <div className="flex flex-col justify-between space-y-12">
                            ...
                            <div>
                                ...
                                <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
                                    <div className="space-y-2">
                                        ...
                                        <p className="text-lg font-medium text-gray-900 dark:text-white">+1 (800) 123-4567</p>
                                        <p className="text-xs text-gray-500 dark:text-gray-400">Available 24/7 for VIP Service</p>
                                    </div>
                                    <div className="space-y-2">
                                        <div className="flex items-center gap-3 text-gold">
                                            <Mail size={18} />
                            ...
                            <div className="space-y-6">
                                <h3 className="text-[11px] font-bold tracking-[0.3em] text-gray-400 uppercase">Flagship Boutiques</h3>
                                <div className="space-y-4">
                                    {[
                                        { city: "New York", address: "123 Diamond Avenue, NY 10036", hours: "10AM - 8PM Daily" },
                                        { city: "London", address: "45 Mayfair Street, W1K 2PB", hours: "10AM - 7PM Mon-Sat" },
                                        { city: "Ho Chi Minh City", address: "99 Dong Khoi, District 1, HCMC", hours: "9AM - 9PM Daily" }
                                    ].map((location, i) => (
                                        <div key={location.city} className="flex gap-4 rounded-2xl border border-gray-100 p-6 transition-colors hover:bg-gray-50 dark:border-white/5 dark:hover:bg-white/5">
                                            <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-gold/10 text-gold">
                                                <MapPin size={20} />
                                            </div>
                                            <div>
                                                <h4 className="text-sm font-bold text-gray-900 dark:text-white">{location.city}</h4>
                            ...
                            {/* Social Presence */}
                            <div className="space-y-6">
                                <h3 className="text-[11px] font-bold tracking-[0.3em] text-gray-400 uppercase">Connect With Us</h3>
