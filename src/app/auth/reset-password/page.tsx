                ...
                <div className="mx-auto max-w-[480px]">
                    ...
                    <div className="rounded-2xl border border-gray-100 bg-white p-8 shadow-sm dark:border-white/5 dark:bg-[#0a0a0a]">
                        <div className="mb-8 flex flex-col items-center text-center">
                            ...
                            <h2 className="mb-2 text-2xl font-bold text-gray-900 dark:text-white">New Password</h2>
                            <p className="text-sm text-gray-500 dark:text-gray-400">Update your access for secure browsing</p>
                        </div>
